...
大容量PLYはcommitしない。固定版3本と検分カメラ版3本のCC0派生動画をPRに含める。
...
- 追加版は固定注視点のまま左右周回、見下ろし、見上げ、弱いドリーを12秒で行う。
...
- targeted pytest: `8 passed in 0.88s`（カメラ軌道2件を追加）
- full pytest: CPU稼働を継続したまま304秒でtimeout。元processはtimeoutで終了し、二重起動なし
- GPU: NVIDIA GeForce RTX 5070
- fixed videos: 3本とも960×960、12 fps、96 frames、8.000秒、H.264 yuv420p
- animated-camera videos: 3本とも960×960、12 fps、144 frames、12.000秒、H.264 yuv420p
- visual QA: 固定版は各1・4・7秒、追加版は各1・5・9・11.5秒
- committed artifacts:
  - `media/cc0-cactus-eraser.mp4`
  - `media/cc0-cactus-dark-flashlight.mp4`
  - `media/cc0-cactus-annihilation.mp4`
  - `media/cc0-cactus-eraser-orbit.mp4`
  - `media/cc0-cactus-dark-flashlight-orbit.mp4`
  - `media/cc0-cactus-annihilation-orbit.mp4`
