...
- Stage 1 cell orchestration: [`stage1_orchestration_protocol.md`](stage1_orchestration_protocol.md) / [`stage1_orchestration.py`](stage1_orchestration.py)
...
- gates: [`../../tests/test_negativity_budget.py`](../../tests/test_negativity_budget.py) / [`../../tests/test_negativity_budget_packet2.py`](../../tests/test_negativity_budget_packet2.py) / [`../../tests/test_negativity_budget_stage1_setup.py`](../../tests/test_negativity_budget_stage1_setup.py) / [`../../tests/test_negativity_budget_stage1_orchestration.py`](../../tests/test_negativity_budget_stage1_orchestration.py) / [`../../tests/test_negativity_budget_stage1_objective.py`](../../tests/test_negativity_budget_stage1_objective.py) / [`../../tests/test_negativity_budget_stage1_adam_step.py`](../../tests/test_negativity_budget_stage1_adam_step.py) / [`../../tests/test_negativity_budget_stage1_runner.py`](../../tests/test_negativity_budget_stage1_runner.py) / [`../../tests/test_negativity_budget_stage1_barrier_selection.py`](../../tests/test_negativity_budget_stage1_barrier_selection.py)

各packetのscopeとresult境界は対応するprotocolだけを正本とし、このREADMEは入口だけを置く。

```powershell
python -m pytest -p no:cacheprovider tests\test_negativity_budget.py tests\test_negativity_budget_packet2.py tests\test_negativity_budget_stage1_setup.py tests\test_negativity_budget_stage1_orchestration.py tests\test_negativity_budget_stage1_objective.py tests\test_negativity_budget_stage1_adam_step.py tests\test_negativity_budget_stage1_runner.py tests\test_negativity_budget_stage1_barrier_selection.py -q
```
