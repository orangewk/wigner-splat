...
固定カメラ版3本は960×960、12 fps、96 frames、8秒、H.264 yuv420p。
...
追加の検分カメラ版3本は960×960、12 fps、144 frames、12秒、H.264 yuv420p。
注視点を維持しながら左右へ緩く周回し、水平から見下ろし、最後に控えめな
見上げへ移る。Dark flashlightは効果の読みやすさを保つため上下移動を半減する。

- [Eraser — animated camera](media/cc0-cactus-eraser-orbit.mp4)
- [Dark flashlight — animated camera](media/cc0-cactus-dark-flashlight-orbit.mp4)
- [Annihilation — animated camera](media/cc0-cactus-annihilation-orbit.mp4)
...
検分カメラ版は同じコマンドへ`--camera-motion orbit --seconds 12`を追加する。
軌道は固定注視点、効果別の左右18–25°、見下ろし最大10°、見上げ最大6°、
距離変化8%以内を滑らかに補間する。
