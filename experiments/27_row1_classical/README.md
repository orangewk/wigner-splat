...
| --- | --- | --- | --- | --- |
| E27-D0 | Issue #126 / row 1 programme | [orange's 2026-09-03 decision](https://github.com/orangewk/wigner-splat/issues/126#issuecomment-5521760656) | **closed — incomplete pilot** | Closing the issue records the end of this attempt; it is not acceptance or completion of the proposed programme. |
...
`R_obs`, it must pre-register a quantum solver independent of the radial WKB
route, bind that solver and the classical calculation to the same physical
target and initial ensemble, and state a fixed-SHA independent-review gate.
The files in this directory remain the evidence for the closed attempt rather
